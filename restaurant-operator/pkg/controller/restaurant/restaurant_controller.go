...
import (
	...
	restaurantv1alpha1 "github.com/ruromero/presentations/restaurant-operator/pkg/apis/restaurant/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &restaurantv1alpha1.Restaurant{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &restaurantv1alpha1.Restaurant{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRestaurant) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &restaurantv1alpha1.Restaurant{}
...
func newPodForCR(cr *restaurantv1alpha1.Restaurant) *corev1.Pod {
